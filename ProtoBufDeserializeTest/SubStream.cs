...
namespace ProtoBufDeserializeTest
{
    ...
    //original code credit goes to Marc Gravell: https://social.msdn.microsoft.com/Forums/vstudio/en-US/c409b63b-37df-40ca-9322-458ffe06ea48/how-to-access-part-of-a-filestream-or-memorystream
    public class SubStream : Stream
    {
        ...
        public SubStream(Stream baseStream, long offset, long length, SeekOrigin streamSeekOrigin=SeekOrigin.Current)
        {
            ...
            {
                baseStream.Seek(offset, streamSeekOrigin);
            }
            else
            { // read it manually...
